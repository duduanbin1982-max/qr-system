...
const products = ref([])
    ...
    function getAttachmentIcon(fileType) {
      if (!fileType) return '\U0001f4c4'
      const t = fileType.toLowerCase()
      if (t.includes('image')) return '\U0001f5bc\ufe0f'
      if (t.includes('pdf')) return '\U0001f4d5'
      if (t.includes('cad') || t.includes('dwg') || t.includes('dxf')) return '\U0001f4d0'
      if (t.includes('word') || t.includes('doc')) return '\U0001f4dd'
      if (t.includes('excel') || t.includes('sheet')) return '\U0001f4ca'
      return '\U0001f4c4'
    }
