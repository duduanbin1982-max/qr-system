<template>
  <div class="modal-overlay">
    <div class="modal" style="max-width:620px">
      <div class="modal-header"><span>主管评议 - {{ score.user_name }}</span><span class="modal-close" @click="$emit('close')">&times;</span></div>
      ...
      <div class="modal-footer"><button class="btn" @click="$emit('close')">取消</button><button class="btn btn-primary" @click="$emit('save')">保存并重算</button></div>
    </div>
  </div>
</template>
