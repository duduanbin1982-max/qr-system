...
function waiverReasonLabel(code) { const options = [...(waiverPolicy.value.historical_reasons || []), ...(waiverPolicy.value.live_reasons || [])]; return options.find(option => option.code === code)?.label || (code || '历史记录未分类') }
