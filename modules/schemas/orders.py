...
orders_schemas = {
 ...
 'properties': {'orders': {'items': {'additionalProperties': True,
                                     'properties': {'customer': {'maxLength': 128, 'type': 'string'},
                                                    ...
                                                    'priority_level': {'maximum': 5, 'minimum': 1, 'type': 'integer'},
                                                    'is_expedited': {'type': ['boolean', 'integer']},
                                                    'priority_reason': {'maxLength': 1024, 'type': 'string'},
                                                    'priority_effective_at': {'maxLength': 32, 'type': 'string'},
                                                    'schedule_policy': {'enum': ['auto', 'no_split', 'allow_split', 'allow_cross_day'], 'type': 'string'},
                                                    'schedule_change_reason': {'maxLength': 1024, 'type': 'string'}},
                                     'required': ['order_no'],
                                     'type': 'object'},
                           'maxItems': 200,
                           'type': 'array'}},
