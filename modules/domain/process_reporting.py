"""Pure process reportability and active-position selection policy."""
...
class ProcessReportingPolicy:
    ...
    def attach_context(
        ...
        for index, process in enumerate(processes):
            ...
            completed_process = cls.is_completed(process, order_quantity)
        ...
        order_data["current_process"] = cls.summary(selected, order_quantity)
