...
ACTION_PERMISSION_DEFS = {
    ...
    "trace": ("产品追溯", ["view"]),
    "approvals": ("审批", ["view", "create", "edit", "decision"]),
    "approval_policies": (
        "审批策略",
        ["view", "create", "submit", "approve", "reject", "history", "impact"],
    ),
    "reports": ("数据分析", ["view"]),
    "board": ("数据看板", ["view"]),
    ...
    "process_config": (
        "工艺配置",
        ["view", "create", "submit", "approve", "reject", "history"],
    ),
    ...
    "production_nodes": (
        "生产节点",
        ["view", "manage", "capability_manage", "calendar_manage", "downtime_manage"],
    ),
    "schedules": (
        "节点排程",
...
ACTION_PAGE_MAP = {
    ...
    "production_nodes": ["page:production", "page:production.schedule"],
    "schedules": ["page:production", "page:production.schedule"],
...
PAGE_OPERATION_BINDINGS = {
    ...
    "page:production.schedule": ["schedule", "production_nodes", "schedules"],
    ...
    "page:settings.process-config": ["process_config"],
...
PERMISSION_IMPLICATIONS = {
    ...
    "process_config:submit": ["process_config:view"],
    "process_config:approve": ["process_config:view"],
    "process_config:reject": ["process_config:view"],
    "process_config:history": ["process_config:view"],
    "approval_policies:create": ["approval_policies:view"],
    "approval_policies:submit": ["approval_policies:view"],
    "approval_policies:approve": ["approval_policies:view"],
    "approval_policies:reject": ["approval_policies:view"],
    "approval_policies:history": ["approval_policies:view"],
    "approval_policies:impact": ["approval_policies:view"],
    "approvals:decision": ["approvals:view"],
    "processes:view": ["process_versions:view"],
    "routes:view": ["route_versions:view"],
    "production_nodes:manage": ["production_nodes:view"],
    "production_nodes:capability_manage": ["production_nodes:view"],
    "production_nodes:calendar_manage": ["production_nodes:view"],
    "production_nodes:downtime_manage": ["production_nodes:view"],
    "schedules:generate": ["schedules:view"],
    "schedules:adjust": ["schedules:view"],
    "schedules:lock": ["schedules:view"],
